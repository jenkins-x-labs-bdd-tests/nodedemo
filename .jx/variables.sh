...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-labs-bdd-tests/nodedemo/master/4'
...
export MINK_IMAGE='ghcr.io/jenkins-x/nodedemo:1.0.63'
