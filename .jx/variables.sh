...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-labs-bdd-tests/nodedemo/master/2'
...
export MINK_IMAGE='ghcr.io/jenkins-x/nodedemo:1.0.59'
